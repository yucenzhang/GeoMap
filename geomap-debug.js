define("geomap/geomap/1.0.0/geomap-debug", [ "gallery/jquery/1.8.3/jquery-debug", "gallery/raphael/2.1.0/raphael-debug" ], function(require, exports, module) {
    /*
*
* Author: Yang Dongxu
* Date: 12-12-29
...
*/
    ...
    var $ = require("gallery/jquery/1.8.3/jquery-debug"), Raphael = require("gallery/raphael/2.1.0/raphael-debug");
    (function() {
        ...
        GeoMap.prototype = {
            ...
            showLoadingTip: function(t) {
                var self = this, canvas = self.canvas, txt, box, w, h;
            ...
            removeLoadingTip: function() {
                var self = this, tip = self.canvas.getById("loadingTip"), box = self.canvas.getById("loadingTipBox");
                if (tip) {
                    tip.remove();
                    box.remove();
                }
            ...
            // 绘制地图
            render: function() {
                /* 支持两个参数 config, callback */
                var self = this, canvas = self.canvas, xhr, sx, sy, argtype, callback = function() {}, config = {};
            ...
            // 绑定拖动
            dragMove: function() {
                var self = this, v = self.viewBox, c = $(self.canvas.canvas), bool = false, oX = 0, oY = 0;
            ...
            viewScale: function(type) {
                var self = this, v = self.viewBox, w = v.w, h = v.h, a = v.a, b = v.b, s = 1;
                switch (type) {
                  case "up":
                    s += .2;
                    break;
